...
return(
 ...
 <div className="relative">
  <img src={Eye} alt="hide" className="w-6 absolute mt-TOP ml-RIGHT cursor-pointer" onClick={hid} ref={eyeO}/>
  <img src={EyeSlash} alt="hide" className="w-6 absolute mt-TOP ml-RIGHT cursor-pointer hidden" onClick={sho} ref={eyeOs}/>
 <input type="password" ref={inputShowHideO} className="w-THREESEVEN pt-2.5 pb-2.5 pl-3 pr-14 rounded-xl border-2 text-sm"required/>
 </div>
 </div>
  <div className="mt-6">
 <label className="text-xs font-normal pb-1.5">Ulangi Password Baru</label>
 <div className="relative">
  <img src={Eye} alt="hide" className="w-6 absolute mt-TOP ml-RIGHT cursor-pointer" onClick={show} ref={eye}/>
  <img src={EyeSlash} alt="hide" className="w-6 absolute mt-TOP ml-RIGHT cursor-pointer hidden" onClick={hide} ref={eyeS}/>
 <input type="password" ref={inputShowHide} className="w-THREESEVEN pt-2.5 pb-2.5 pl-3 pr-14 rounded-xl border-2 text-sm "required/>
 </div>
   <div className="mt-8">
